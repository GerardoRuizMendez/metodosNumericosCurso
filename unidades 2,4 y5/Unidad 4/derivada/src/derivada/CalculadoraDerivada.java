...
public class CalculadoraDerivada extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(59, 131, 189));
        jLabel1.setText("Función a derivar:");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(59, 131, 189));
        jLabel2.setText("Función derivada:");

        texFuncion.setBackground(new java.awt.Color(60, 63, 65));
        ...
        jLabel3.setForeground(new java.awt.Color(59, 131, 189));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        JOptionPane.showMessageDialog(null, "Calculadora de derivadas\nDesarrollado por: El código del equipo dinamita"
                + "", "El código del equipo dinamita", JOptionPane.INFORMATION_MESSAGE);
